...
node_data = range(2, 22, 2)
for node_value in node_data:
    link_list.append(node_value)

link_list.insert_at(3, 7)
link_list.insert_at(0, 56)
link_list.insert_after(link_list.head, 45)
link_list.update_position(5, 67)
link_list.update_node(link_list.head.next.next.next, 97)
link_list.update_value(97, 17)
link_list.update_value(14, 17)
link_list.update_value(20, 17)
link_list.update_all(17, 97)
link_list.delete_node(link_list.head.next.next)
link_list.delete_node(link_list.head)
link_list.delete_position(6)
link_list.delete_position(0)
link_list.delete_value(67)
link_list.delete_all(97)
print(link_list.collect_values())
link_list.delete_linked_list()

# Creating loop
new_values = range(3, 33, 3)
for node_data in new_values:
    link_list.append(node_data)

# Detecting the loop with stack
link_list.head.next.next.next.next = link_list.head.next.next
state = link_list.detect_loop_using_stack()
if state:
    print("Loop Detected using Stack")

# Detecting the loop with Floyd
state = link_list.detect_loop_using_floyd()
if state:
    print("Loop Detected using Floyd")

# Fixing the loop using Floyd
link_list.fix_loop_using_floyd()

# Reversing the Linked List
link_list_rev = LinkedList()
rev_values = range(2, 22, 2)
for rev_data in rev_values:
    link_list_rev.append(rev_data)

link_list_rev.reverse()
